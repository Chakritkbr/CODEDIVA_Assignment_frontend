...
const Footer = () => {
  return (
    <footer className='@container'>
      <div className='z-[3] flex size-full items-center justify-center border-none bg-surface-onsurface-black @sm:h-[230px] @sm:px-20 @sm:py-24 @xl:h-[110px] @xl:px-[50px]'>
        <section className='relative mx-auto w-full p-24  max-w-screen-2xl !gap-y-16 !pb-24 @sm:p-0 @sm:!pb-0'>
          <div className='z-[3] flex size-full w-full shrink-0 flex-col flex-wrap items-start justify-start gap-y-12 border-none bg-surface-black @sm:items-center @sm:justify-center @sm:gap-y-16 @xl:h-[40px] @xl:flex-row @xl:items-center @xl:justify-between'>
            <svg
              width={144}
              height={35}
              viewBox='0 0 144 35'
            ...
            <div className='item-center flex grow flex-col gap-y-12 @sm:justify-center @xl:flex-row @xl:justify-evenly'>
              ...
              <div className='flex flex-row flex-wrap items-center justify-start gap-12 @sm:justify-center @xl:gap-8'>
                <ul className='footer-menu footer-primary-menu flex shrink-0 flex-row flex-wrap space-x-8'>
                  <li>
                    <a
                      href='https://www.facebook.com/weloveswensens/?locale=th_TH'
                      target='_blank'
                    >
                      <Image
                        alt='facebook-icon'
                  ...
                  <li>
                    <a
                      href='https://www.instagram.com/we_love_swensens?igsh=MWxjZGtmaXI0NzdjYQ=='
                      target='_blank'
                    >
                      <Image
                        alt='instagram-icon'
                  ...
                  <li>
                    <a
                      href='https://liff.line.me/1645278921-kWRPP32q/?accountId=qic0396o'
                      target='_blank'
                    >
                      <Image
                        alt='line-icon'
                        ...
                        className='shrink-0'
                        style={{ color: 'transparent' }}
                        src='/assets/logo_line.svg'
                      />
                    </a>
                  </li>
                  <li>
                    <a
                      href='https://www.tiktok.com/@we_love_swensens?_t=8mmJ5PBRfSk&_r=1'
                      target='_blank'
                    >
                      <Image
                        alt='tiktok-icon'
                        ...
                        className='shrink-0'
                        style={{ color: 'transparent' }}
                        src='/assets/logo_tiktok.svg'
                      />
                    </a>
                  </li>
                </ul>
                <div className='flex shrink-0'>
                  <a href='https://apps.apple.com/th/app/swensens-ice-cream/id1553427962'>
                    <Image
                ...
                <div className='mx-0 flex h-auto shrink-0 flex-wrap'>
          ...
          <footer className='flex w-full flex-col-reverse items-start justify-start border-none pt-16 @sm:justify-center @xl:pt-0 sm:flex-row'>
            <div className='text-body-sm-regular text-text-invert'>
